                                    ...
                                    <div id="signup">
                                        ...
                                        <form action="/" method="post">
                                            ...
                                            <div class="field-wrap">
                                                ...
                                                <input type="email" required autocomplete="none" />
                                            </div>
                                            ...
                                            <div class="field-wrap">
                                                ...
                                                <input type="tel" required autocomplete="none" />
                                            </div>
                                            <div class="field-wrap">
                                                <label>
...
.create_profile_section  *, *:before, *:after {
...
.create_profile_section input {
 ...
 .create_profile_section input, textarea {
   font-size: 11px;
   display: block;
   width: 100%;
   height: 100%;
 ...
 .create_profile_section input:focus, .create_profile_section textarea:focus {
   outline: 0;
 ...
 .create_profile_section .button:hover, .button:focus {
   background: #179b77;
   cursor:pointer;
}
