...
<div class="new-users">
    ...
    <div class="bg-blue-50 min-h-screen p-6 text-lg" style=" background: transparent;">
        <form x-data="serviceRequestForm()" class="max-w-screen-lg  mx-auto p-10 shadow"
            style="border-radius: 25px;background-color: var(--color-white); ">
            ...
            <div x-show="currentStep === 0" class="flex flex-col mt-4 p-4 md:flex-row">
                ...
                <div class="flex-1">
                    <label class="inline-block w-full cr">
                        ...
                        <input x-model="values.firstName"
                            class="w-full cr px-3 py-2 border focus:border-blue-800 focus:outline-none"
                            type="text" />
                    </label>

                    <label class="inline-block w-full cr mt-2">
                        <p class="  ">NAME -SURNAME (ENGLISH)</p>
                        <input x-model="values.lastName"
                            class="w-full cr px-3 py-2 border focus:border-blue-400 focus:outline-none"
                            type="text" />
                    </label>
                    <label class="inline-block w-full cr mt-2">
                        <p class="  ">PASSWORD</p>
                    ...
                    <label class="inline-block w-full cr">
                        ...
                        <select x-model="values.computerType"
            ...
            <div x-show="currentStep === 1" x-cloak
                class="flex flex-col mt-4 p-4 md:flex-row transition-all">
                <div class="flex-1">
                ...
                <div class="flex-1">
                    ...
                    <label class="inline-block w-full cr mt-4">
                        ...
                        <input x-model="values.computerType1"
                            class="w-full cr px-3 py-2 border focus:border-blue-400 focus:outline-none"
                            type="text" />
                    </label>
                    ...
                    <label class="inline-block w-full cr mt-4">
                        ...
                        <input x-model="values.problemMessage"
                            class="w-full cr px-3 py-2 border focus:border-blue-400 focus:outline-none"
                            type="text" />
                    </label>
                    ...
                    <label class="inline-block w-full cr mt-4">
                        ...
                        <input x-model="values.problemMessage1"
                            class="w-full cr px-3 py-2 border focus:border-blue-400 focus:outline-none"
                            type="text" />
                    </label>
                    <label class="inline-block w-full cr mt-4 ">
                        <p class="  ">อัปโหลดรูปภาพ</p>
                        <input x-model="values.photo"
                            class="w-full cr px-3 py-2 border focus:border-blue-400 focus:outline-none hk"
                            type="file" />
                    </label>
            ...
            <div x-show="currentStep === 2" x-cloak
                ...
                <div class="flex-1">
                    <h4 class="font-semibold text-xl">ข้อมูลพนักงาน <button
                            @click.prevent="currentStep = 0"
                            class="text-base font-semibold text-blue-600">Edit</button></h4>
                    <p class="mt-2 "><span x-text="values.firstName"></span> <span
                            x-text="values.lastName"></span></p>
                    ...
                    <div class="w-full flex mt-10 -mb-4">
                        ...
                        <button type="submit"
                            class="px-6 py-2 bg-blue-500 font-semibold text-white">Submit</button>
                    </div>
                </div>
            </div>
        </form>
